...
"                </tr>");
            //Tables 
                ...
                out.println("<td><div class=\"dropdown\"><button class=\"dropbtn\">Select the Backup Schedule from the Below Dropdown</button><div class=\"dropdown-content\">");
                Statement st2=con1.createStatement();
                ResultSet schedules =st2.executeQuery("select * from parent.schedule");
 
                while(schedules.next()){
                          String mod = "<a href=\"Res?tab="
